...
void Lvgl_Example1(void){
  ...
  lv_obj_t *temp_objects[] = {SD_Size, FlashSize, BAT_Volts, Board_angle, RTC_Time, Wireless_Scan, Backlight_subtract, Backlight_add, sw};
...
/////////////////////////////////////////////////////////
  ...
  static lv_coord_t grid_1_col_dsc[] = {LV_GRID_FR(1), LV_GRID_FR(2), LV_GRID_FR(10), LV_GRID_FR(2), LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_set_grid_cell(panel1_title, LV_GRID_ALIGN_CENTER, 1, 3, LV_GRID_ALIGN_CENTER, 0, 1);
  ...
  static lv_coord_t grid_2_col_dsc[] = {LV_GRID_FR(4),  LV_GRID_FR(1),  LV_GRID_FR(1),  LV_GRID_FR(1), LV_GRID_FR(4), LV_GRID_TEMPLATE_LAST};
